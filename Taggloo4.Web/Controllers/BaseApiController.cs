...
/// <summary>
/// Represents a base class for Taggloo4.Web Controllers to inherit from, gaining access to a number of helper functions.
/// </summary>
[ApiController]
...
public class BaseApiController : ControllerBase
{
	...
	/// <summary>
	/// Returns the base Taggloo4.Web path, including version suffix, for the current hosting platform.
	/// </summary>
	/// <returns>The base Taggloo4.Web path, including version suffix, eg. <c>http://taggloo.im/api/v4</c>.</returns>
	...
	/// <summary>
	/// Asserts that the request is respecting Taggloo4.Web user constraints.
	/// </summary>
	/// <param name="itemCount">Requested number of items requested.</param>
	/// <exception cref="BadHttpRequestException">Request breaches Taggloo4.Web constraints.</exception>
