...
public class ImportWordJob
{
    ...
    public void ImportWord(string remoteHostAddress,
	    ...
	    string theWord,
	    int dictionaryId, Guid importGuid)
    {
	    ...
	    Word word = CreateNewWordOrGetExistingWord(theWord, dictionaryId, remoteHostAddress, currentUserName, importGuid);
	...
	private Word CreateNewWordOrGetExistingWord(string word, int dictionaryId, string remoteHostAddress,
		string? currentUserName, Guid importGuid)
	{
